 ...
 */
var SubscriberCreateCommand = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, SubscriberCreateCommand.createFile(process.cwd() + "/" + (directory ? (directory + "/") : "") + filename, fileContent)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    SubscriberCreateCommand.createFile = function (path, content) {
