 ...
 */
var EntityCreateCommand = (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, EntityCreateCommand.createFile(process.cwd() + "/" + (directory ? (directory + "/") : "") + filename, fileContent)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
     ...
     */
    EntityCreateCommand.createFile = function (path, content) {
