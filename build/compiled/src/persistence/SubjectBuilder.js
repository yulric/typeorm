                                ...
                                switch (_a.label) {
                                    ...
                                    case 16:
                                        promises_2 = databaseEntities_1.map(function (databaseEntity) { return __awaiter(_this, void 0, void 0, function () {
                                            var relatedEntitySubject, relatedValue, _a;
                                            return __generator(this, function (_b) {
                                                switch (_b.label) {
                                                    ...
                                                    case 1:
                                                        ...
                                                        return [3 /*break*/, 3];
                                                    case 2:
                                                        if (relation.isOneToMany && relation.inverseRelation && relation.deReferenceRelation === false) {
                                                            relatedEntitySubject.relationUpdates.push({
                                                                relation: relation.inverseRelation,
                                                                value: (_a = {},
                                                                    _a[relation.entityMetadata.primaryColumn.name] = relation
