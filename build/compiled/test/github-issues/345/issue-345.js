...
describe("github issues > Join query on ManyToMany relations not working", function () {
    ...
    it("embedded with custom column name should persist and load without errors", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
