...
describe("github issues > OneToOne relation with referencedColumnName does not work", function () {
    var connections;
    ...
    it("custom join column name and referencedColumnName", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
