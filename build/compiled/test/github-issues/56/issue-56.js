...
describe.skip("github issues > #56 relationships only work when both primary keys have the same name", function () {
    ...
    it("should persist successfully and return persisted entity", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, connection.getRepository(AccessToken_1.AccessToken).persist(token).then(function (token) {
                    return connection.getRepository(User_1.User).persist(user);
                }).then(function (user) {
                    chai_1.expect(user).not.to.be.empty;
                    user.should.be.eql({
                        id: 1,
