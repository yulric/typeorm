...
describe("github issues > #71 ManyToOne relation with custom column name persistence fails", function () {
    ...
    it("should persist successfully entity successfully with its many-to-one relation", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, connection.entityManager.persist(artikel)];
                case 1:
                    _a.sent();
                ...
                case 2:
                    ...
                    chai_1.expect(kollektion).not.to.be.empty;
                    chai_1.expect(loadedArtikel).not.to.be.empty;
