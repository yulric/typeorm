...
describe("github issues > #190 too many SQL variables when using setMaxResults in SQLite", function () {
    ...
    it("should not fail if high max results is used", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
