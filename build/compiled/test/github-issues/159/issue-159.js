...
describe("github issues > #159 Referencing ClassTableChild build table error", function () {
    var connections;
    ...
    it("entity should be successfully referenced to class-table entity", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, connection.entityManager.persist(department)];
                case 1:
                    _a.sent();
...
//# sourceMappingURL=issue-159.js.map