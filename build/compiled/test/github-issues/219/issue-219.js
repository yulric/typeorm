...
describe("github issues > #219 FindOptions should be able to resolve null values", function () {
    ...
    it("should properly query null values", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var promises, i, post1, postsWithoutText1, postsWithText1, postsWithoutText2, postsWithText2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    promises = [];
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, connection.entityManager.find(Post_1.Post, { text: null })];
                case 2:
                    postsWithoutText1 = _a.sent();
                    postsWithoutText1.length.should.be.equal(5);
                    return [4 /*yield*/, connection.entityManager.find(Post_1.Post, { text: "about post" })];
                case 3:
