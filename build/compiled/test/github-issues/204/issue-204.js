...
describe("github issues > #204 jsonb array is not persisted correctly", function () {
    ...
    it("should persist json and jsonb arrays correctly", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, connection.entityManager.persist(record)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, connection.entityManager.findOneById(Record_1.Record, record.id)];
                case 2:
                    foundRecord = _a.sent();
