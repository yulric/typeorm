...
describe("github issues > #176 @CreateDateColumn and @UpdateDateColumn does not read back in UTC", function () {
    ...
    it("should return dates in utc", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var post1, loadedPosts1, rawPost, localDate;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                ...
                case 3:
                    rawPost = _a.sent();
                    localDate = !(rawPost["post_localDate"] instanceof Date) ? new Date(rawPost["post_localDate"]) : rawPost["post_localDate"];
