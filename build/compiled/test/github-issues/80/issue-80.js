...
describe("github issues > #80 repository.persist fails when empty array is sent to the method", function () {
    var connections;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    chai_1.expect(returnedPost).not.to.be.empty;
                    returnedPost.should.be.equal(post);
                    return [2 /*return*/];
            }
        });
    }); })); });
    it("should not fail if empty array is given to persist method", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
        var posts, returnedPosts;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    posts = [];
                    return [4 /*yield*/, connection.entityManager.persist(posts)];
                case 1:
