...
var PostDetails_1 = require("../../sample/sample3-many-to-one/entity/PostDetails");
var Post_1 = require("../../sample/sample3-many-to-one/entity/Post");
var PostCategory_1 = require("../../sample/sample3-many-to-one/entity/PostCategory");
var PostAuthor_1 = require("../../sample/sample3-many-to-one/entity/PostAuthor");
var PostMetadata_1 = require("../../sample/sample3-many-to-one/entity/PostMetadata");
var PostImage_1 = require("../../sample/sample3-many-to-one/entity/PostImage");
var PostInformation_1 = require("../../sample/sample3-many-to-one/entity/PostInformation");
    ...
    describe("cascade remove should be executed when cascadeRemove option is set", function () {
        ...
        it("should remove a relation entity successfully when removed", function () {
            ...
            return postMetadataRepository
                ...
                chai_1.expect(reloadedPost.metadata).to.be.empty;
            });
        });
    });
