...
describe("persistence > multi primary keys", function () {
    ...
    describe("insert", function () {
        var _this = this;
        it("should insert entity when when there are multi column primary keys", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
