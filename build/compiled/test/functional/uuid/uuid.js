    ...
    before(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    connections = _a.sent();
                    return [4 /*yield*/, Promise.all(connections.map(function (connection) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    chai_1.expect(schema.columns.find(function (columnSchema) { return columnSchema.name === "id" && columnSchema.type === "uuid" && columnSchema.isGenerated; })).to.be.not.empty;
                    return [2 /*return*/];
            }
        });
    }); })); });
