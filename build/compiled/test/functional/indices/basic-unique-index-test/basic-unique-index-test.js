...
describe("indices > basic unique index test", function () {
    ...
    describe("unique index", function () {
        var _this = this;
        it("should work without errors", function () { return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
            var customer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, connection.entityManager.persist(customer)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
