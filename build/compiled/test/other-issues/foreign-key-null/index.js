...
describe("Foreign Key is Null", function () {
    ...
    it("should not set the author column in the database to NULL", function () {
        ...
        return Promise.all(connections.map(function (connection) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
            var postOne, author, postTwo, posts;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        postOne = new Post_1.Post();
                        ...
                        return [4 /*yield*/, connection.entityManager.transaction(function (entityManager) { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, entityManager.getRepository(Author_1.Author)
                                                .persist(author)];
                                        case 1:
                                            _a.sent();
                                            return [4 /*yield*/, entityManager.getRepository(Post_1.Post)
                                                    .persist(postOne)];
                                        case 2:
                                            _a.sent();
                                            return [2 /*return*/];
                    ...
                    case 3:
                        ...
                        posts.forEach(function (post) {
                            chai_1.expect(post.author).to.exist;
                        });
                        return [2 /*return*/];
                }
            });
