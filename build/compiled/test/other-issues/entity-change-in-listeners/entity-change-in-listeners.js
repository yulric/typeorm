...
describe("other issues > entity change in listeners should affect persistence", function () {
    var connections;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, connection.entityManager.findOne(Post_1.Post)];
                    case 2:
                        loadedPost = _a.sent();
                        ...
                        return [4 /*yield*/, connection.entityManager.persist(loadedPost)];
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, connection.entityManager.findOne(Post_1.Post)];
                    case 4:
                        loadedUpdatedPost = _a.sent();
                        chai_1.expect(loadedUpdatedPost).not.to.be.empty;
