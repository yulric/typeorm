...
var EverythingEntity_1 = require("./entity/EverythingEntity");
var options = {
    driver: {
        type: "mysql",
        host: "localhost",
    ...
    autoSchemaSync: true,
    entities: [EverythingEntity_1.EverythingEntity]
};
index_1.createConnection(options).then(function (connection) {
    var entity = new EverythingEntity_1.EverythingEntity();
    ...
    postRepository
        ...
        .catch(function (error) { return console.log("Cannot save. Error: ", error, error.stack); });
