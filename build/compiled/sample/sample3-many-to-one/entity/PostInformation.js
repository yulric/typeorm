...
var PostInformation = (function () {
    ...
    __decorate([
        index_1.OneToMany(function (type) { return Post_1.Post; }, function (post) { return post.information; }, {
            cascadeUpdate: true,
        }),
        __metadata("design:type", Array)
    ], PostInformation.prototype, "posts", void 0);
    PostInformation = __decorate([
        index_1.Entity("sample3_post_information")
    ], PostInformation);
